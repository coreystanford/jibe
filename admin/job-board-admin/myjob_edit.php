...
<section role=main>
    ...
    <div class="main-admin">
        ...
        <h1>Edit a job posting <?php echo $job_title; ?>
            <form name="delete-form" method="post" action="?action=delete_job" class="job-inline">
                <input type="hidden" name="job_id" value="<?php echo $job_id; ?>" />
                <button type="submit" name="deletejob" class="fa fa-trash-o" onclick="return confirm('This job listing will be deleted permanently. \n Continue?')" />
            </form>
        </h1>
