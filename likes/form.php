...
<form method="post" name="submit-like" id="submit_like" class="submit_like">
    ...
    if(is_null($like_id) || empty($like_id) || $like_id == 0){
        $action = "Like";
    }
    else {
        $action = "Unlike";
    ...
    <button type="submit" name="btn_submit_like" id="btn_submit_like" class="btn submit btn_like" value="<?php echo $action; ?>" ><?php echo $action; ?></button>
</form>
    <span id="result"></span>
