...
<section role=main>
    ...
    <div class="slim clearfix">
            <h1>Edit a job posting <?php echo $job_title; ?></h1>
    ...
    <textarea type="text" name="job_description" class="job-textarea" value="<?php echo $job_description; ?>" cols="20" rows="10" >
        ...
        <input type="submit" name="submitjob" value="Update" class="job-inline-button" />
        <input type="reset" name="resetjob" value ="Cancel" class="job-inline-button" />
            </form>
    <form name="delete-form" method="post" action="?action=delete_job" >
        <input type="hidden" name="job_id" value="<?php echo $job_id; ?>" />
        <input type="submit" name="deletejob" value="Delete" class="job-inline-button" />
